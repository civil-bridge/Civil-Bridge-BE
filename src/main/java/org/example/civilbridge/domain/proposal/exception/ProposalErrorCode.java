package org.example.civilbridge.domain.proposal.exception;
...
public enum ProposalErrorCode implements ErrorCode {
    ...
    LOCK_NOT_ACQUIRED(409, "P010", "편집 권한을 먼저 획득해주세요. (start-editing 호출 필요)"),
    ...
    ALREADY_COMPLETED(409, "P013", "이미 완료된 제안서입니다."),
    INSUFFICIENT_CONSENTS(409, "P017", "목표 동의 인원에 도달하지 않아 결과를 확정할 수 없습니다."),
