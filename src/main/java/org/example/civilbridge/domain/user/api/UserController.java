package org.example.civilbridge.domain.user.api;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import lombok.RequiredArgsConstructor;
import org.example.civilbridge.common.dto.ApiResponse;
import org.example.civilbridge.domain.user.api.dto.EmailVerificationRequest;
import org.example.civilbridge.domain.user.api.dto.SignUpRequest;
import org.example.civilbridge.domain.user.api.dto.SignUpResponse;
import org.example.civilbridge.domain.user.api.dto.VerifyEmailRequest;
import org.example.civilbridge.domain.user.application.UserService;
